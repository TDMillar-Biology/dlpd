'''
Docstring for visualization.dotplot
Barebones dot plot functions
'''
...
def render_sv(sv, ax):
    ax.plot([sv.reference_start, sv.reference_start], [sv.query_start, sv.query_end], color = 'yellow') ## plot the x component
    ax.plot([sv.reference_start, sv.reference_end], [sv.query_start, sv.query_start], color = 'yellow') ## plot the y component
